...
const PageContainer = ({
  ...
  return (
    <main className='bg-black p-2 lg:p-4 overflow-hidden'>
      ...
      <div className='pointer-events-none fixed left-0 right-0 top-0 z-50 h-14 overflow-hidden after:absolute after:inset-2 after:h-20 after:rounded-t-xl after:content-[""] after:[box-shadow:_0px_0px_0px_2000px_rgb(0,0,0)] after:lg:inset-4'></div>
      <div
        className={clsx(
