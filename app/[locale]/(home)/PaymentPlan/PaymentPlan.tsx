        ...
        <Heading3 className='flex items-center gap-x-4'>
          <div className='flex flex-col gap-y-4'>
            <svg
              viewBox='0 0 24 24'
              strokeWidth={1.5}
              className={clsx(iconStyles, 'stroke-emerald-700')}
            >
              <path
                strokeLinecap='round'
            ...
            <svg
              viewBox='0 0 24 24'
              strokeWidth={1.5}
              className={clsx(iconStyles, 'stroke-yellow-700')}
            >
              <path
                strokeLinecap='round'
                strokeLinejoin='round'
        ...
        <Heading3 className='flex items-center gap-x-4'>
          <div className='flex flex-col gap-y-4'>
            <svg
              ...
              viewBox='0 0 24 24'
              strokeWidth={1.5}
              className={clsx(iconStyles, 'stroke-blue-600')}
            >
              <path
                strokeLinecap='round'
                strokeLinejoin='round'
            ...
            <svg
              ...
              viewBox='0 0 24 24'
              strokeWidth={1.5}
              className={clsx(iconStyles, 'stroke-slate-500')}
            >
              <path
                strokeLinecap='round'
                strokeLinejoin='round'
        ...
        <Heading3 className='flex items-center gap-x-4'>
          <div className='flex flex-col gap-y-4'>
            <svg
              ...
              viewBox='0 0 24 24'
              strokeWidth={1.5}
              className={clsx(iconStyles, 'stroke-violet-600')}
            >
              <path
                strokeLinecap='round'
                strokeLinejoin='round'
            ...
            <svg
              ...
              viewBox='0 0 24 24'
              strokeWidth={1.5}
              className={clsx(iconStyles, 'stroke-fuchsia-800')}
            >
              <path
                strokeLinecap='round'
                strokeLinejoin='round'
