  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'responsive-xl': 'clamp(2.1rem, 0.1714rem + 4.8214vw, 4.8rem)',
        // 'responsive-2xl': 'clamp(2.6rem, 8vw, 7.3rem)',
        'responsive-2xl': 'clamp(2.6rem, -0.7571rem + 8.3929vw, 7.3rem)',
        // 'responsive-3xl': 'clamp(2.8rem, 10.2vw, 9.5rem)',
        'responsive-3xl': 'clamp(2.8rem, -1.9857rem + 11.9643vw, 9.5rem)',
        // 'responsive-hero': 'clamp(3.5rem, 13vw, 11.5rem)',
        'responsive-hero': 'clamp(3.5rem, 1.1129rem + 10.6115vw, 11.6rem)',
      },
      borderRadius: {
        xs: '1px',
      },
